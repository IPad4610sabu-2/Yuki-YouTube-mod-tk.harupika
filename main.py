...
video_apis = [
    ...
    r"https://eu-proxy.poketube.fun",
    r"https://pol1.iv.ggtyler.dev",
    r"https::/cal1.iv.ggtyler.dev",
    r"https://usa-proxy2.poketube.fun",
    r"https://lekker.gay",
    r"https://invidious.privacyredirect.com",
    r"https://invidious.materialio.us",
    r"https://invid-api.poketube.fun",
    r"https://invidious.darkness.service",
...
app.mount("/users/iPad4610", StaticFiles(directory="./blog", html=True), name="static")
...
def home(response: Response,request: Request,yuki: Union[str] = Cookie(None)):
    ...
    print(check_cokie(yuki))
    return redirect("/users/iPad4610")
